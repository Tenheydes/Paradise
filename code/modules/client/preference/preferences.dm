...
/datum/preferences
	...
	var/list/routing = list(
		BROWSER_ROUTING_TCOM_DPT 	= PANE_B,
		BROWSER_ROUTING_TCOM_CMD 	= PANE_A,
		BROWSER_ROUTING_TCOM_SEC 	= PANE_A,
		BROWSER_ROUTING_TCOM_ENG 	= PANE_B,
		BROWSER_ROUTING_TCOM_SCI 	= PANE_B,
		BROWSER_ROUTING_TCOM_MED 	= PANE_B,
		BROWSER_ROUTING_TCOM_PRC 	= PANE_B,
		BROWSER_ROUTING_TCOM_SUP 	= PANE_C,
		BROWSER_ROUTING_TCOM_SRV	= PANE_C,
		BROWSER_ROUTING_TCOM_PUB 	= PANE_C,

		BROWSER_ROUTING_TELEPATHY	= PANE_A,
		BROWSER_ROUTING_TCOM_EVT 	= PANE_A, // Synd, Syndteam, ERT, Deathsquad

		BROWSER_ROUTING_ADMIN    	= PANE_A,
		BROWSER_ROUTING_SERVER    	= PANE_A,
		BROWSER_ROUTING_ATTACK   	= PANE_B,
		BROWSER_ROUTING_AHELP   	= PANE_C,
		BROWSER_ROUTING_MHELP   	= PANE_C,

		BROWSER_ROUTING_UNSORTED 	= PANE_O,
	)
